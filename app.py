...
# ── Page config ──────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="Deep Research · AI Research Agent",
    page_icon="🔬",
    layout="wide",
...
<div class="hero">
    ...
    <p class="hero-sub" style="max-width:100%;text-align:center;">
...
st.markdown("""
<div class="notice">
    Deep Research · Powered by LangChain multi-agent pipeline · Built with Streamlit
</div>
""", unsafe_allow_html=True)